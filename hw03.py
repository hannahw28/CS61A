...
def count_change(total):
    ...
    def help(total,n=0):
        if total<=1:
            ...
            return help(total//2,n+1)

    num = pow(2,help(total))
    def cc2(total,num):
        if total==0:
            return 1
        elif total<0:
            ...
            with_num=cc2(total-num,num)
            without_num=cc2(total,num//2)
            return with_num+without_num
    return cc2(total,num)
...
def missing_digits(n):
    ...
    if n<10:
        ...
        if last==last2:
            ...
            return missing_digits(n)+last-last2-1
